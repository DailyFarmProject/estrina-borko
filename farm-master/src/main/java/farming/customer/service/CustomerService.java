...
public class CustomerService implements ICustomerService {
    ...
    public void createCustomerProfile(User user) {
        ...
        if (customerRepo.existsByUserAccountEmail(user.getEmail())) {
            log.warn("Customer profile already exists for login: {}", user.getEmail());
            throw new ResponseStatusException(HttpStatus.CONFLICT, "Customer profile already exists for login: " + user.getEmail());
        }
        ...
        log.info("Customer profile created for login: {}", user.getEmail());
    }
    ...
    public Optional<CustomerDto> getCustomerByLogin(String login) {
        ...
        return customerRepo.findByUserAccountEmail(login)
                .map(Customer::build);
    }
